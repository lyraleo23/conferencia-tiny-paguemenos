...
def obter_vendedores_v3(access_token):
    url = f'https://api.tiny.com.br/public-api/v3/vendedores'
    print(url)
...
def obter_contatos_v3(access_token, params):
    offset = 0
    total = 100
    lista_contatos = []
    ...
    while offset < total:
        try:
            url = f'https://api.tiny.com.br/public-api/v3/contatos?{url_params}offset={offset}'
            print(url)
            ...
            lista_contatos = [*lista_contatos, *response['itens']]
        except Exception as e:
            print(e)
            time.sleep(5)
...
def obter_contato_v3(access_token, id_contato):
    url = f'https://api.tiny.com.br/public-api/v3/contatos/{id_contato}'
    print(url)
...
def alterar_contato_v3(access_token, id_contato, payload):
    url = f'https://api.tiny.com.br/public-api/v3/contatos/{id_contato}'
    print(url)
